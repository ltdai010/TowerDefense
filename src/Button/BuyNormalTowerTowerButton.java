...
public class BuyNormalTowerTowerButton extends BuyTowerButton {


    public BuyNormalTowerTowerButton(int locationX, int locationY, BunchOfTower bunch, GameField gameField, Map map) {
