...
public class BuySniperTowerTowerButton extends BuyTowerButton {


    public BuySniperTowerTowerButton(int locationX, int locationY, BunchOfTower bunch, GameField gameField, Map map) {
