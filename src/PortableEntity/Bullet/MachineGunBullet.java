...
public class MachineGunBullet extends Bullet {
    ...
    public MachineGunBullet(int locationX, int locationY, double angle) {
        super(locationX, locationY);
        super.damage = MachineGunBullet.damage;
        loadImage();
    }
    ...
    {
        ImageIcon ii = new ImageIcon("src\\img\\machinegun_bullet.png");
